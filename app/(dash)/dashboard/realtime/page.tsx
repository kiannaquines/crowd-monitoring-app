      ...
      <Card className='shadow-sm'>
        ...
        <Card className="col-span-4 row-span-6 shadow-sm">
          <CardContent className='py-3'>
              ...
              <small className='text-slate-500 text-sm'>Overall overview in realtime.</small>
              <OverViewVisit/>
          </CardContent>
        </Card>
        <Card className="col-span-4 row-span-6 shadow-sm">
          <CardContent className='py-3'>
              ...
              <small className='text-slate-500 text-sm'>Overall section utilization in realtime.</small>
              <UtilizationGraph/>
          </CardContent>
        </Card>
      </div>
